<template>
    ...
    <div class="layout-page-category">

        <pull-down-up>

            <div class="category_content col_content">
                ...
                <div class="col_item">
                    <svg class="icon iconfont col_icon" aria-hidden="true">
                        <use xlink:href="#icon-guochandonghua"></use>
                    </svg>
                    <p>国产</p>
                </div>
                <div class="col_item">
                ...
                <div class="col_item">
                    <svg class="icon iconfont col_icon" aria-hidden="true">
                        <use xlink:href="#icon-shishang"></use>
                    </svg>
                    <p>时尚</p>
                </div>
                <div class="col_item">
                ...
                <div class="col_item">
                    <svg class="icon iconfont col_icon" aria-hidden="true">
                        <use xlink:href="#icon-jilupian"></use>
                    </svg>
                    <p>记录片</p>
                </div>
                <div class="col_item">
                ...
                <div class="col_item">
                    <svg class="icon iconfont col_icon" aria-hidden="true">
                        <use xlink:href="#icon-fangyingting"></use>
                    </svg>
                    <p>放映厅</p>
                </div>
                <div class="col_item">
                    <svg class="icon iconfont col_icon" aria-hidden="true">
                        <use xlink:href="#icon-xiaoshipin"></use>
                    </svg>
                    <p>小视频</p>
                </div>
                <div class="col_item">
